...
export class Sphere {
    ...
    equals(that) {
        return that !== null && this.origin.equals(that.origin) && this.radius === that.radius && this.transform.equals(that.transform) && this.material.equals(that.material);
    }
