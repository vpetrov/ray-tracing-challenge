...
test('Lighting with the eye between the light and the surface', () => {
    ...
    expect(color.equals(new Color(1.9, 1.9, 1.9, 1.9))).toBeTruthy();
});
...
test('Lighting with eye opposite surface, light offset 45', () => {
    ...
    expect(color.equals(new Color(0.7364, 0.7364, 0.7364, 0.7364))).toBeTruthy();
});
...
test('Lighting with eye in the path of the reflection vector', () => {
    ...
    expect(color.equals(new Color(1.6364, 1.6364, 1.6364, 1.6364))).toBeTruthy();
});
...
test('Lighting with the light behind the surface', () => {
    ...
    expect(color.equals(new Color(0.1, 0.1, 0.1, 2.1))).toBeTruthy();
});
