import { PointLight, Material, Phong, schlick } from './shading.mjs';
import { Sphere, World, Ray, Intersection, Plane, DefaultWorld, GlassSphere } from './geometry.mjs';
import { Color, Point, Vector, Matrix } from './tuple.mjs';
import { Stripe } from './patterns.mjs';
...
test('clone() with color returns a copy of the material', () => {
    const m1 = new Material(Color.RED, 1, 2, 3, 4, 5);
    const m2 = m1.clone();
