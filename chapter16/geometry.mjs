...
export class BoundsCube extends Cube {
    constructor(objectBounds, transform, material) {
        ...
        const xscale = (maxp.x - minp.x) / 2;
        const yscale = (maxp.y - minp.y) / 2;
        const zscale = (maxp.z - minp.z) / 2;
        ...
        // console.log('- minPoint:', objectBounds.minPoint);
        // console.log('- maxPoint:', objectBounds.maxPoint);
