...
export class Phong {
    static shade(material, light, position, eye, normal, in_shadow) {
    ...
    static shadeHit(world, info) {
        return Phong.shade(info.object.material, world.light, info.overPoint, info.eyev, info.normalv, world.isShadowed(info.overPoint));
    }
}
